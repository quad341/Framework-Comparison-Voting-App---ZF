<?php
// scripts/load.1.sqlite.php
// taken from the Zend Framework Quickstart at
...
// the schema file.
try {
    $schemaSql = file_get_contents(dirname(__FILE__) . '/schema.1.sqlite.sql');
    ...
    if ($withData) {
        $dataSql = file_get_contents(dirname(__FILE__) . '/data.1.sqlite.sql');
        // use the connection directly to load sql in batches
